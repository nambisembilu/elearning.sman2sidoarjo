...
class _RubrikMapelStaffDetailScreenState extends ConsumerState<RubrikMapelStaffDetailScreen> {
  ...
  void _navigateToEditRubrik() async {
    final prefs = await SharedPreferences.getInstance();

    // Simpan data yang diperlukan untuk edit
    await prefs.setBool('is_new_rubrik', false);
    await prefs.setInt('edit_lingkup_materi_id', widget.lingkupMateriId);

    // Navigasi ke kelola rubrik screen dengan mode edit
    context.push('/dashboard/guru/rubrik-mata-pelajaran/kelola-rubrik');
  }
  ...
  //       color: widget.statusKunci ? Colors.green[50] : Colors.orange[50],
  //       borderRadius: BorderRadius.circular(20),
  //       border: Border.all(
  //         color: widget.statusKunci ? Colors.green : Colors.orange,
  //         width: 1,
  //       ),
  //     ),
  //     child: Row(
  ...
  //       children: [
  //         Icon(
  //           widget.statusKunci ? Symbols.lock : Symbols.lock_open,
  //           size: 16,
  //           color: widget.statusKunci ? Colors.green : Colors.orange,
  //         ),
  //         const SizedBox(width: 4),
  //         Text(
  //           widget.statusKunci ? 'Terkunci' : 'Terbuka',
  //           style: TextStyle(
  //             fontSize: 12,
